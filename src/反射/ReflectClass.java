...
public class ReflectClass {
    ...
    public static void reflectPrivateMethod() {
        try {
            Class<?> classBook = Class.forName("反射.Book");
           // Method methodBook = classBook.getDeclaredMethod("declaredMethod", Integer.class);
            Method methodBook = classBook.getDeclaredMethod("declaredMethod", String.class, String.class, String.class);
            methodBook.setAccessible(true);
            Object objectBook = classBook.newInstance();
          //  String string = (String) methodBook.invoke(objectBook,0);
            String string = (String) methodBook.invoke(objectBook,"a","b","c");
